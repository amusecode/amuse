...
if sys.hexversion > 0x03000000:
    ...
    from support3.setup_codes import (
            BuildCodes, CleanCodes, DistCleanCodes, BuildOneCode,
            BuildLibraries
            )
...
def find_data_files(srcdir, destdir, *wildcards, **kw):
    ...
    def walk_helper(arg, dirname, files):
        ...
        for wc in wildcards:
            ...
            for f in files:
                ...
                if (
                        fnmatch.fnmatch(filename, wc_name)
    ...
    if recursive:
        ...
        walk_helper(
                (file_list, wildcards, converter, destdir),
                srcdir,
                [
...
setup(
        ...
        package_dir={
            '': 'src',
            'amuse.test.suite': 'test',
            'amuse.examples': 'examples',
            },
        packages=packages,
