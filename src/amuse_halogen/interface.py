...
class Halogen(CommonCode):
    ...
    def define_parameters(self, handler):
        handler.add_method_parameter(
            ...
            "set_model_alpha",
            "alpha",
            "alpha parameter in density profile (see src/amuse_halogen/src/doc for details)",
            default_value = -1.0
        )
        ...
        handler.add_method_parameter(
            ...
            "set_model_beta",
            "beta",
            "beta parameter in density profile (see src/amuse_halogen/src/doc for details)",
            default_value = -1.0
        )
        ...
        handler.add_method_parameter(
            ...
            "set_model_gamma",
            "gamma",
            "gamma parameter in density profile (see src/amuse_halogen/src/doc for details)",
            default_value = -1.0
        )
        ...
        handler.add_method_parameter(
            ...
            "set_scale_radius",
            "scale_radius",
            "the scale radius of the density profile (see src/amuse_halogen/src/doc for details)",
        ...
        handler.add_method_parameter(
            ...
            "set_cutoff_radius",
            "cutoff_radius",
            "the cutoff radius of the density profile (see src/amuse_halogen/src/doc for details)",
            default_value = -1.0 | nbody_system.length
        )
    ...
    def define_errorcodes(self, handler):
        ...
        handler.add_errorcode(-2, 'Missing or bad parameter for halo (see src/amuse_halogen/src/doc for details on required parameters).')
