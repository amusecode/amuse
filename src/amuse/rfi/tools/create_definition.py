...
class CreateFortranStub(object):
    ...
    def output_subprogram_start(self):
        ...
        for parameter in self.specification.parameters:
            ...
            new_length_of_the_line = (
                self.out.number_of_characters_on_current_line
                + length_of_the_argument_statement
            )
    ...
    def output_subprogram_content(self):
        if not self.specification.result_type is None:
            ...
            (
                ...
                + "="
                + self.dtype_to_returnvalue[self.specification.result_type]
            )
