...
from amuse.community.interface.gd import (
    ...
    GravityFieldInterface, GravityFieldCode
)

from amuse.units import generic_unit_system, nbody_system, units
...
class FiInterface(
    ...
    def __init__(self, mode=MODE_NORMAL, **options):
        ...
        if "number_of_workers" in options and options["number_of_workers"] != 1:
            raise Exception(
                "Fi expects number_of_workers to be 1,\nfor multiple processors use mode='openmp' and set the OMP_NUM_THREADS environment variable"
            )

        CodeInterface.__init__(
            self, name_of_the_worker=self.name_of_the_worker(mode), **options
        )
    ...
    def set_sqrttstp():
        ...
        function.addParameter(
            "square_root_timestep_flag", dtype="i", direction=function.IN
        )
        function.result_type = "i"
        return function
    ...
    def get_sqrttstp():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            "square_root_timestep_flag", dtype="i", direction=function.OUT
        )
        function.result_type = "i"
        return function
    ...
    def set_freetstp():
        """
        set_freetstp([0,1]):
        use freeform (v/freev)**freevexp * (a/freea)**freeaexp timestep crit if 1
        """
        function = LegacyFunctionSpecification()
        function.addParameter(
            "freeform_timestep_flag", dtype="i", direction=function.IN
        )
        function.result_type = "i"
        return function
    ...
    def get_freetstp():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            "freeform_timestep_flag", dtype="i", direction=function.OUT
        )
        function.result_type = "i"
        return function
    ...
    def set_usequad():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            "quadrupole_moments_flag", dtype="i", direction=function.IN
        )
        function.result_type = "i"
        return function
    ...
    def get_usequad():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            "quadrupole_moments_flag", dtype="i", direction=function.OUT
        )
        function.result_type = "i"
        return function
    ...
    def set_adaptive_eps():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            "adaptive_smoothing_flag", dtype="i", direction=function.IN
        )
        function.result_type = "i"
        return function
    ...
    def get_adaptive_eps():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            "adaptive_smoothing_flag", dtype="i", direction=function.OUT
        )
        function.result_type = "i"
        return function
    ...
    def set_gdgop():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            "gadget_cell_opening_flag", dtype="i", direction=function.IN
        )
        function.result_type = "i"
        return function
    ...
    def get_gdgop():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            "gadget_cell_opening_flag", dtype="i", direction=function.OUT
        )
        function.result_type = "i"
        return function
    ...
    def get_consph():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            "conservative_sph_flag", dtype="i", direction=function.OUT
        )
        function.result_type = "i"
        return function
    ...
    def set_uentropy():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            "integrate_entropy_flag", dtype="i", direction=function.IN
        )
        function.result_type = "i"
        return function
    ...
    def get_uentropy():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            "integrate_entropy_flag", dtype="i", direction=function.OUT
        )
        function.result_type = "i"
        return function
...
class GlFiInterface(FiInterface):
    ...
    def get_image_target():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            "x", dtype="d", direction=function.OUT, unit=nbody_system.length
        )
        function.addParameter(
            "y", dtype="d", direction=function.OUT, unit=nbody_system.length
        )
        function.addParameter(
            "z", dtype="d", direction=function.OUT, unit=nbody_system.length
        )
        function.result_type = "i"
        return function
    ...
    def set_image_target():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            "x", dtype="d", direction=function.IN, unit=nbody_system.length
        )
        function.addParameter(
            "y", dtype="d", direction=function.IN, unit=nbody_system.length
        )
        function.addParameter(
            "z", dtype="d", direction=function.IN, unit=nbody_system.length
        )
        function.result_type = "i"
        return function
    ...
    @legacy_function
    def get_image_angle():
        """angle of image in x direction (for perspective projection)"""
        function = LegacyFunctionSpecification()
        function.addParameter(
            "image_angle", dtype="d", direction=function.OUT, unit=units.deg
        )
        function.result_type = "i"
        return function
    ...
    def set_image_angle():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            "image_angle", dtype="d", direction=function.IN, unit=units.deg
        )
        function.result_type = "i"
        return function
    ...
    def get_image_ratio():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            "image_ratio", dtype="d", direction=function.OUT, unit=None
        )
        function.result_type = "i"
        return function
...
class Fi(GravitationalDynamics, GravityFieldCode):
    ...
    def initialize_code(self):
        ...
        self.parameters.fi_data_directory = (
            self.legacy_interface.get_data_directory() + "/"
        )
    ...
    def define_parameters(self, handler):
        ...
        handler.add_boolean_parameter(
            ...
            "set_radiate",
            "radiation_flag",
            "Radiation flag. True means: radiation (i.e. radiative cooling/heating) "
            "is included. False means: no radiation, and implies no star formation.",
            False,
        )
        ...
        handler.add_boolean_parameter(
            ...
            "set_use_hydro",
            "use_hydro_flag",
            "Hydrodynamics flag. True means: SPH hydro included, False means: gravity "
            "only.",
            True,
        )
        ...
        handler.add_boolean_parameter(
            ...
            "Square-root-timestep flag. True means: use sqrt(eps/acc) timestep "
            "criterion.",
            False,
        )
        ...
        handler.add_boolean_parameter(
            ...
            "Freeform-timestep flag. True means: use freeform (v/freev)**freevexp "
            "* (a/freea)**freeaexp timestep criterion.",
            False,
        )
        ...
        handler.add_boolean_parameter(
            ...
            "Quadrupole-moments flag. True means: calculate and use quadrupole cell "
            "moments.",
            False,
        )
        ...
        handler.add_boolean_parameter(
            ...
            "set_selfgrav",
            "self_gravity_flag",
            "Self-gravity flag. False means: self-gravity is not used, only external "
            "potentials.",
            True,
        )
        ...
        handler.add_boolean_parameter(
            ...
            "Adaptive-smoothing flag. True means: use of adaptive gravity smoothing "
            "for all particles.",
            False,
        )
        ...
        handler.add_boolean_parameter(
            ...
            "Gadget-cell-opening flag. True means: use of Gadget cell opening "
            "criterion.",
            True,
        )
        ...
        handler.add_boolean_parameter(
            ...
            "Conservative-SPH flag. True means: use Springel & Hernquist conservative "
            "SPH form (currently the only option).",
            True,
        )
        ...
        handler.add_boolean_parameter(
            ...
            "set_sphinit",
            "sph_dens_init_flag",
            "SPH-density-init flag. True means: initialize sph density and h_smooth "
            "(most probably useless for AMUSE interface).",
            True,
        )
        ...
        handler.add_boolean_parameter(
            ...
            "Integrate-entropy flag. True means: integrate entropy, else: internal "
            "energy.",
            True,
        )
        ...
        handler.add_boolean_parameter(
            ...
            "set_isotherm",
            "isothermal_flag",
            "Isothermal flag. True means: isothermal gas (requires "
        ...
        handler.add_boolean_parameter(
            ...
            "set_eps_is_h",
            "eps_is_h_flag",
            "Eps-is-h flag. True means: set gas particles gravitational epsilon to h "
        ...
        handler.add_method_parameter(
            ...
            "set_rhomax",
            "max_density",
            "Maximum density in case of star formation (force SF if exceeded, ignored "
            "if star formation is off)",
    ...
    def define_methods(self, handler):
        ...
        handler.add_method(
            "get_internal_energy",
            (handler.INDEX,),
            (nbody_system.specific_energy, handler.ERROR_CODE),
        )
        handler.add_method(
            "get_dinternal_energy_dt",
            (handler.INDEX,),
            (nbody_system.specific_energy / nbody_system.time, handler.ERROR_CODE),
        )
        handler.add_method(
        ...
        handler.add_method(
            "get_density", (handler.INDEX,), (nbody_system.density, handler.ERROR_CODE)
        )
        handler.add_method(
            "get_pressure",
            (handler.INDEX,),
        ...
        handler.add_method(
            "get_star_tform", (handler.INDEX,), (nbody_system.time, handler.ERROR_CODE)
        )
        ...
        handler.add_method("set_dtime", (nbody_system.time,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_firstsnap", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_stepout", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_steplog", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_max_tbin", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_minppbin", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_targetnn", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_verbosity", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_nsmooth", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method(
            "set_pboxsize", (nbody_system.length,), (handler.ERROR_CODE,)
        )
        ...
        handler.add_method("set_unitm_in_msun", (units.MSun,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_unitl_in_kpc", (units.kpc,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_tstepcrit", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_tstpcr2", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_freev", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_freea", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_freevexp", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_freeaexp", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_bh_tol", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_gdgtol", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_nn_tol", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_epsgas", (nbody_system.length,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_gamma", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_alpha", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_beta", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_epssph", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_courant", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_removgas", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method(
            "set_consthsm", (nbody_system.length,), (handler.ERROR_CODE,)
        )
        ...
        handler.add_method("set_nsmtol", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_graineff", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method(
            "set_crionrate", (1.8e-17 * units.s**-1,), (handler.ERROR_CODE,)
        )
        ...
        handler.add_method("set_heat_par1", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_heat_par2", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_cool_par", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_optdepth", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_tcollfac", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_masscrit", (units.MSun,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_sfeff", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_tbubble", (units.Myr,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_sne_eff", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_tsnbeg", (units.Myr,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_rhomax", (nbody_system.density,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_halofile", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_feedback", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method("set_sfmode", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method(
            "set_hupdatemethod", (handler.NO_UNIT,), (handler.ERROR_CODE,)
        )
        ...
        handler.add_method("set_sph_visc", (handler.NO_UNIT,), (handler.ERROR_CODE,))
        ...
        handler.add_method(
            "set_fi_data_directory", (handler.NO_UNIT,), (handler.ERROR_CODE,)
        )
    ...
    def update_particle_set(self):
        ...
        incode_storage = self.gas_particles._remove_indices_in_attribute_storage(
            indices_to_remove
        )
...
class FiViewer(Fi):
    ...
    def __init__(self, convert_nbody=None, mode="normal", **options):
        Fi.__init__(
            self, convert_nbody=convert_nbody, mode=mode, use_gl=True, **options
        )
...
class FiMapInterface(CodeInterface):
    ...
    def new_particle():
        ...
        for x in ["x", "y", "z"]:
            function.addParameter(x, dtype="d", direction=function.IN)
        function.addParameter("weight", dtype="d", direction=function.IN, default=1.0)
        function.addParameter("radius", dtype="d", direction=function.IN, default=0.0)
        function.addParameter(
            "opacity_area", dtype="d", direction=function.IN, default=0.0
        )
...
class FiMap(CommonCode):
    ...
    def define_methods(self, handler):
        ...
        handler.add_method(
            "set_minimum_distance", (generic_unit_system.length,), (handler.ERROR_CODE,)
        )
        handler.add_method(
        ...
        handler.add_method(
            "set_image_width", (generic_unit_system.length,), (handler.ERROR_CODE,)
        )
        handler.add_method(
            "get_image_width",
            (),
    ...
    def define_parameters(self, handler):
        ...
        handler.add_vector_parameter("image_size", "image pixel size", ("nx", "ny"))
