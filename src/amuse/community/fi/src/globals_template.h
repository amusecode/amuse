      ...
      PARAMETER(nbodsmax=20000000,nsphmax=20000000)
     ...
     &  isotherm,eps_is_h,mingaseps,balsara,hupdatemethod,sph_visc
     ...
     &  enerror,amvec(ndim),cmpos(ndim),cmvel(ndim)
      ...
      LOGICAL sphinit,starform, uentropy,eps_is_h,mingaseps,balsara
