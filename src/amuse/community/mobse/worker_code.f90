program amuse_worker_program
  ...
  parameter (MAX_INTEGERS_IN=8)
  parameter (MAX_INTEGERS_OUT=2)
  parameter (MAX_STRINGS_IN=2)
  parameter (MAX_STRINGS_OUT=1)
  parameter (MAX_DOUBLES_IN=26)
  parameter (MAX_DOUBLES_OUT=26)
      ...
      CASE(1713719459)
        do i = 1, call_count, 1
          CALL evolve_binary( &
            ...
            doubles_in(( 13 * call_count) + i) ,&
            doubles_in(( 14 * call_count) + i) ,&
            doubles_in(( 15 * call_count) + i) ,&
            doubles_in(( 16 * call_count) + i) ,&
            doubles_in(( 17 * call_count) + i) ,&
            doubles_in(( 18 * call_count) + i) ,&
            doubles_in(( 19 * call_count) + i) ,&
            doubles_in(( 20 * call_count) + i) ,&
            doubles_in(( 21 * call_count) + i) ,&
            doubles_in(( 22 * call_count) + i) ,&
            doubles_in(( 23 * call_count) + i) ,&
            doubles_in(( 24 * call_count) + i) ,&
            doubles_in(( 25 * call_count) + i) &
          )
          integers_out(i) = integers_in(i)
          integers_out(( 1 * call_count) + i) = integers_in(( 1 * call_count) + i)
          ...
          doubles_out(( 13 * call_count) + i) = doubles_in(( 13 * call_count) + i)
          doubles_out(( 14 * call_count) + i) = doubles_in(( 14 * call_count) + i)
          doubles_out(( 15 * call_count) + i) = doubles_in(( 15 * call_count) + i)
          doubles_out(( 16 * call_count) + i) = doubles_in(( 16 * call_count) + i)
          doubles_out(( 17 * call_count) + i) = doubles_in(( 17 * call_count) + i)
          doubles_out(( 18 * call_count) + i) = doubles_in(( 18 * call_count) + i)
          doubles_out(( 19 * call_count) + i) = doubles_in(( 19 * call_count) + i)
          doubles_out(( 20 * call_count) + i) = doubles_in(( 20 * call_count) + i)
          doubles_out(( 21 * call_count) + i) = doubles_in(( 21 * call_count) + i)
          doubles_out(( 22 * call_count) + i) = doubles_in(( 22 * call_count) + i)
          doubles_out(( 23 * call_count) + i) = doubles_in(( 23 * call_count) + i)
          doubles_out(( 24 * call_count) + i) = doubles_in(( 24 * call_count) + i)
          doubles_out(( 25 * call_count) + i) = doubles_in(( 25 * call_count) + i)
        end do
        header_out(HEADER_INTEGER_COUNT) = 2 * call_count
        header_out(HEADER_DOUBLE_COUNT) = 26 * call_count
