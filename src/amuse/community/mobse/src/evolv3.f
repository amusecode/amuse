***
      SUBROUTINE evolv3(kstar,mass0,mass,rad,lumin,massc,radc,
...
*
         ...
         mass00(k) = m0
*
* Masses over 150Msun should probably not be trusted in the
* evolution formulae.
*
         if(mt.gt.150.d0)then
            WRITE(99,*)' MASS EXCEEDED in evolv3.f',mass1i,mass2i,
     &                 tbi,ecci,mt
            goto 140
         endif
*
...
*
      ...
      tb = tb*yeardy
      if(jp.ge.80)then
         WRITE(99,*)' EVOLV3 ARRAY ERROR ',mass1i,mass2i,tbi,ecci
         WRITE(*,*)' STOP: EVOLV3 ARRAY ERROR '
         CALL exit(0)
         STOP
      elseif(jp.ge.60)then
         WRITE(99,*)' EVOLV3 ARRAY WARNING ',mass1i,mass2i,tbi,ecci,jp
      endif
      bcm(ip+1,1) = -1.0
      bpp(jp+1,1) = -1.0
*
