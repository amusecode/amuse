...
from amuse.community.fdps_sd.interface import FDPSInterface
from amuse.community.fdps_sd.interface import FDPS
import math

class FDPSInterfaceTests(TestWithMPI):
    
    def test1(self):
        instance = self.new_instance_of_an_optional_code(FDPSInterface)
...
#    def test3(self):
#        instance = FDPSInterface()
#        self.assertEquals(0, instance.set_eps2(0.101))
#        self.assertEquals([0.101, 0], instance.get_eps2().values())
#        self.assertEquals(0, instance.set_eps2(0.2))
#        self.assertEquals([0.2, 0], instance.get_eps2().values())
#        interface.stop()
#
#    def test4(self):
#        instance = FDPSInterface()
#        self.assertEquals([0, 0], instance.get_is_time_reversed_allowed().values())
#        self.assertEquals(0, instance.set_is_time_reversed_allowed(1))
#        self.assertEquals([1, 0], instance.get_is_time_reversed_allowed().values())
#        instance.stop()
#
    def test5(self):
        instance = FDPSInterface()
...
#        retrieved_state = instance.get_state(0)
#        
#        retr = instance.get_potential_at_point(0.01, 0,0,0)
...
#    
#    def test9(self):
#        print "Test FDPSInterface evolve_model"
#        instance = FDPSInterface()
...
#    
#    def test6(self):
#        print "Test6: Testing FDPS parameters"
...
#    
#    def test7(self):
#        print "Test7: Testing effect of FDPS parameter epsilon_squared"
...
#       
#        instance = FDPS(number_of_workers=1)#, debugger="xterm")
#        instance.initialize_code()
...
#        for n in [2,3,4,5]:
#            instance = FDPS(number_of_workers=n)
#            instance.initialize_code()
#            instance.parameters.epsilon_squared = 0.01 | nbody_system.length ** 2
#            instance.particles.add_particles(particles)
#            
...
#        instance.parameters.epsilon_squared = 0.0 | units.AU**2
#        instance.parameters.end_time_accuracy_factor = 0.0
#        instance.parameters.is_time_reversed_allowed = True
#        
#        stars = self.new_system_of_sun_and_earth()
#        earth = stars[1]
#                
...
#    
#        instance = FDPS(convert_nbody)
#        encoded_interface = pickle.dumps(instance,0)
...
#        print instance.particles.key, particles[1].key
#        print instance.stopping_conditions.out_of_box_detection.particles(0)
#        self.assertTrue(instance.stopping_conditions.out_of_box_detection.is_set())
...
#        instance.evolve_model(1 | nbody_system.time)
#        print instance.particles.x
#        self.assertAlmostRelativeEquals(instance.model_time, 1 | nbody_system.time)
#        self.assertAlmostRelativeEquals(instance.particles[0].x, 1 | nbody_system.length)
#        instance.evolve_model(1.5 | nbody_system.time)
#        print instance.particles.x
#        self.assertAlmostRelativeEquals(instance.model_time, 1.5 | nbody_system.time)
#        self.assertAlmostRelativeEquals(instance.particles[0].x, 1.5 | nbody_system.length)
#        instance.stop()
#        
#
#
