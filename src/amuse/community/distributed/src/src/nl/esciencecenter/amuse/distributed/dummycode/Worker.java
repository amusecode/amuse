 ...
 public static class AmuseMessage {
  ...
  private boolean handleCall() throws IOException {
    ...
    switch (request.getFunctionID()) {
      ...
      case -9:
        {
          reply.setIntCount(2 * count);
          reply.ensurePrimitiveCapacity();
          int functionResult;
          int[] int_in = request.getIntSlice(0);
          int[] int_out = new int[count];
          functionResult = code.echo_int(int_in[0], int_out);
          reply.setIntSlice(0, functionResult);
          reply.setIntSlice(1, int_out);
        }
        break;
      ...
      case 38255380:
        {
          ...
          int[] int_in = request.getIntSlice(0);
          int[] int_out = new int[count];
          functionResult = code.echo_array_with_result(int_in, int_out, count);
          reply.setIntSlice(0, functionResult);
          reply.setIntSlice(1, int_out);
        }
        break;
      ...
      case 67571161:
        {
          reply.setIntCount(1 * count);
          reply.ensurePrimitiveCapacity();
          int functionResult;
          String[] string_in = request.getStringSlice(0);
          functionResult = code.print_error_string(string_in);
          reply.setIntSlice(0, functionResult);
        }
        break;
      ...
      case 435653794:
        {
          reply.setIntCount(1 * count);
          reply.setStringCount(2 * count);
          reply.ensurePrimitiveCapacity();
          int functionResult;
          String[] string_inout1 = request.getStringSlice(0);
          String[] string_inout2 = request.getStringSlice(1);
          functionResult = code.echo_strings(string_inout1, string_inout2);
          reply.setIntSlice(0, functionResult);
          reply.setStringSlice(0, string_inout1);
          reply.setStringSlice(1, string_inout2);
        }
        break;
      ...
      case 538734428:
        {
          reply.setIntCount(1 * count);
          reply.setDoubleCount(1 * count);
          reply.ensurePrimitiveCapacity();
          int functionResult;
          double[] double_in = request.getDoubleSlice(0);
          double[] double_out = new double[count];
          functionResult = code.echo_double(double_in, double_out);
          reply.setIntSlice(0, functionResult);
          reply.setDoubleSlice(0, double_out);
        }
        break;
      ...
      case 727361823:
        {
          reply.setIntCount(1 * count);
          reply.ensurePrimitiveCapacity();
          //internal__set_message_polling_interval ignored
        }
        break;
      ...
      case 919768251:
        {
          reply.setIntCount(2 * count);
          reply.ensurePrimitiveCapacity();
          //internal__get_message_polling_interval ignored
        }
        break;
      ...
      case 1023774347:
        {
          reply.setIntCount(1 * count);
          reply.setFloatCount(1 * count);
          reply.ensurePrimitiveCapacity();
          int functionResult;
          float[] float_in = request.getFloatSlice(0);
          float[] float_out = new float[count];
          functionResult = code.echo_float(float_in, float_out);
          reply.setIntSlice(0, functionResult);
          reply.setFloatSlice(0, float_out);
        }
        break;
      ...
      case 1380563396:
        {
          ...
          reply.ensurePrimitiveCapacity();
          int functionResult;
          int[] in_out = request.getIntSlice(0);
          functionResult = code.echo_inout_array_with_result(in_out, count);
          reply.setIntSlice(0, functionResult);
          reply.setIntSlice(1, in_out);
        }
        break;
      ...
      case 1437351593:
        {
          ...
          int[] int_in = request.getIntSlice(0);
          int[] int_out = new int[count];
          code.echo_array(int_in, int_out, count);
          reply.setIntSlice(0, int_out);
        }
        break;
      ...
      case 1594135239:
        {
          reply.setIntCount(1 * count);
          reply.setLongCount(1 * count);
          reply.ensurePrimitiveCapacity();
          int functionResult;
          long[] in = request.getLongSlice(0);
          long[] out = new long[count];
          functionResult = code.echo_long_long_int(in, out);
          reply.setIntSlice(0, functionResult);
          reply.setLongSlice(0, out);
        }
        break;
      ...
      case 1682255642:
        {
          reply.setIntCount(1 * count);
          reply.setStringCount(1 * count);
          reply.ensurePrimitiveCapacity();
          int functionResult;
          String[] string_in = request.getStringSlice(0);
          String[] string_out = new String[count];
          functionResult = code.echo_string(string_in, string_out);
          reply.setIntSlice(0, functionResult);
          reply.setStringSlice(0, string_out);
        }
        break;
      ...
      case 1694846195:
        {
          reply.setIntCount(1 * count);
          reply.setBooleanCount(1 * count);
          reply.ensurePrimitiveCapacity();
          int functionResult;
          boolean[] input = request.getBooleanSlice(0);
          boolean[] output = new boolean[count];
          functionResult = code.echo_logical(input, output);
          reply.setIntSlice(0, functionResult);
          reply.setBooleanSlice(0, output);
        }
        break;
      ...
      case 1837511653:
        {
          ...
          int functionResult;
          String[] string_in = request.getStringSlice(0);
          functionResult = code.print_string(string_in);
          reply.setIntSlice(0, functionResult);
        }
        break;
      ...
      case 1860317006:
        {
          reply.setIntCount(3 * count);
          reply.ensurePrimitiveCapacity();
          int functionResult;
          int[] int_in1 = request.getIntSlice(0);
          int[] int_in2 = request.getIntSlice(1);
          int[] int_out1 = new int[count];
          int[] int_out2 = new int[count];
          functionResult = code.echo_2_int(int_in1, int_in2, int_out1, int_out2, count);
          reply.setIntSlice(0, functionResult);
          reply.setIntSlice(1, int_out1);
          reply.setIntSlice(2, int_out2);
        }
        break;
      ...
      case 2028034328:
        {
          ...
          int[] int_in = request.getIntSlice(0);
          int[] int_out = new int[count];
          functionResult = code.echo_int_array(int_in, int_out);
          reply.setIntSlice(0, functionResult);
          reply.setIntSlice(1, int_out);
        }
        break;
