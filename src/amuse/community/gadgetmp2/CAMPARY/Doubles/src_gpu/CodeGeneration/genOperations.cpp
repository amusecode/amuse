...
static void print_fast_renorm2L_inPlace(int const sX, int const sR){
  ...
  renormFct.open("../Specs/specRenorm.h",ios::app);
	...
	renormFct << "template<>\n";
  renormFct << "__host__ __device__ __forceinline__ void fast_renorm2L<" << sX << "," << sR << ">(double *x){\n";
...
static void print_fast_renorm2L(int const sX, int const sR){
  ...
  renormFct.open("../Specs/specRenorm.h",ios::app);
	...
	renormFct << "template<>\n";
  renormFct << "__host__ __device__ __forceinline__ void fast_renorm2L<" << sX << "," << sR << ">(const double *x, double *r){\n";
...
static void print_renorm2L_4Add1(int const sX, int const sR){
  ...
  renormFct.open("../Specs/specRenorm.h",ios::app);
	...
	renormFct << "template<>\n";
  renormFct << "__host__ __device__ __forceinline__ void renorm2L_4Add1<" << sX << "," << sR << ">(const double *x, const double y, double *r){\n";
...
static void print_baileyAdd(int const K, int const L, int const R){
  if(L==1){
    ...
    addFct.open("../Specs/specAddition.h",ios::app);
	  ...
	  addFct << "template<>\n";
    addFct << "__host__ __device__ __forceinline__ void baileyAdd_fast<" << K << "," << L << "," << R << ">(double const *x, double const *y, double *z){\n";
...
static void print_baileyMul(int const K, int const L, int const R){
  ...
  mulFct.open("../Specs/specMultiplication.h",ios::app);
	...
	mulFct << "template<>\n";
  mulFct << "__host__ __device__ __forceinline__ void baileyMul_fast<" << K << "," << L << "," << R << ">(double const *x, double const *y, double *z){\n";
