...
struct unrollVecSum{
  __host__ __device__ static __forceinline__ void fast_VecSum(double *x, double s){
    s = fast_two_sum(x[from], s, x[from+1]);
    unrollVecSum<from+step,to,step>::fast_VecSum(x, s);
  }
  __host__ __device__ static __forceinline__ void fast_VecSum(const double *x, double s, double *r){
    s = fast_two_sum(x[from], s, r[from+1]);
    unrollVecSum<from+step,to,step>::fast_VecSum(x, s, r);
  }
  __host__ __device__ static __forceinline__ void VecSum(double *x, double s){
    s = two_sum(x[from], s, x[from+1]);
    unrollVecSum<from+step,to,step>::VecSum(x, s);
  }
  __host__ __device__ static __forceinline__ void VecSum(const double *x, double s, double *r){
...
struct unrollVecSum<from,from,step>{
  __host__ __device__ static __forceinline__ void fast_VecSum(double *x, double s){ x[0] = s; }
  __host__ __device__ static __forceinline__ void fast_VecSum(const double *x, double s, double *r){ r[0] = s; }
  __host__ __device__ static __forceinline__ void VecSum(double *x, double s){ x[0] = s; }
  __host__ __device__ static __forceinline__ void VecSum(const double *x, double s, double *r){ r[0] = s; }
};

template<int sX>
__host__ __device__ static __forceinline__ void fast_VecSum(double *x){
	double s = fast_two_sum(x[sX-2], x[sX-1], x[sX-1]);
	#ifdef UNROLL_RENORM
...
template<int sX>
__host__ __device__ static __forceinline__ void fast_VecSum(const double *x, double *r){
...
template<int sX>
__host__ __device__ static __forceinline__ void VecSum(double *x){
  double s = fast_two_sum(x[sX-2], x[sX-1], x[sX-1]);
  #ifdef UNROLL_RENORM
...
template<int sX>
__host__ __device__ static __forceinline__ void VecSum(const double *x, double *r){
  double s = fast_two_sum(x[sX-2], x[sX-1], r[sX-1]);
	#ifdef UNROLL_RENORM
...
template<int sX>
__host__ __device__ static __forceinline__ void VecSum_4Add1(const double *x, const double y, double *r){
...
__host__ __device__ static __forceinline__ void fast_VecSumErrBranch(double *x){
	int ptr = 0, i = 1;
	double e = x[0];
...
template<int sX, int sR>
__host__ __device__ static __forceinline__ void fast_VecSumErrBranch(const double *x, double *r){
  int ptr = 0, i = 1;
  double e = x[0];
...
/***************************************************************/
template<int sX>
__host__ __device__ static __forceinline__ void fast_VecSumErr(double *x){
	double e;
...
template<int sX>
__host__ __device__ static __forceinline__ void fast_VecSumErr(const double *x, double *r){
  double e;
...
// Renormalize
template<int sX, int sR>
__host__ __device__ static __forceinline__ void fast_renorm2L(double *x){
	double e;
	int ptr = 0, i = 2;
...
template<int sX, int sR>
__host__ __device__ static __forceinline__ void fast_renorm2L(const double *x, double *r){
  double e, f[sX];
  int ptr = 0, i = 2;
...
template<int sX, int sR>
__host__ __device__ static __forceinline__ void renorm2L(double *x){
  double e;
  int ptr = 0, i = 2;
...
template<int sX, int sR>
__host__ __device__ static __forceinline__ void renorm2L(const double *x, double *r){
  double e, f[sX];
  int ptr = 0, i = 2;
...
template<int sX, int sR>
__host__ __device__ static __forceinline__ void renorm2L_4Add1(const double *x, const double y, double *r){
  double e, f[sX+1];
  int ptr = 0, i = 2;
...
/** Algorithm for normalizing the array x. The result satisfies |x_i|<ulp(x_{i-1}); P-nonoverlapping expansion.
    ...
    Requirement: sR <= sX **/
template<int sX, int sR>
__host__ __device__ static __forceinline__ void fast_renorm3L(double *x){
  double e;
	int ptr = 0, i = 2;
...
template<int sX, int sR>
__host__ __device__ static __forceinline__ void fast_renorm3L(double *x, double *r){
  double e, f[sX];
  int ptr = 0, i = 2;
...
// Renormalize_random
template<int sX, int sR>
__host__ __device__ static __forceinline__ void renorm_rand2L(double *x){
	double pr;
	int i, j, ptr = 0;
...
template<int sX, int sR>
__host__ __device__ static __forceinline__ void renorm_rand2L(const double *x, double *r){
  double pr, f[sX];
  int i, j, ptr = 0;
