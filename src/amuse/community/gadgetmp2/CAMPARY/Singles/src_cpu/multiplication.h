...
struct unrollPartialProds{
	static void inline unrollX_trunc(const int exp_start, const int LBN, const float *x, const int *exp_x, const float *y, const int *exp_y, float *B){
	...
	static void inline unrollX_all(const int exp_start, const int LBN, const float *x, const int *exp_x, const float *y, const int *exp_y, float *B){
	...
	static void inline unrollY(const int exp_start, const int LBN, const float x, const int exp_x, const float *y, const int *exp_y, float *B){
		float p, e;
	...
	static void inline unroll_simple1(const int exp_start, const int LBN, const float *x, const int *exp_x, const float *y, const int *exp_y, float *B){
		float p;
	...
	static void inline unroll_simple2(const int exp_start, const int LBN, const float *x, const int *exp_x, const float *y, const int *exp_y, float *B){
		float p;
...
static inline void certifiedMul(const float *x, const float *y, float *r){
...
template <int K, int L, int R>
static inline void truncatedMul(const float *x, const float *y, float *r){
	int const LBN = R*dbl_prec/binSize + 2;
  float B[LBN+2], lim[LBN+2];
  int i;
...
template <int K, int L, int R>
static inline void baileyMul_fast(float const *x, float const *y, float *z){
  float p, e, f[R+1];
  int i, j, n = R;
...
template <int K, int L, int R>
static inline void baileyMul_renorm(float const *x, float const *y, float *z){
  float p, e, f[R+1];
  int i, j, n = R;
  for(i=K+L-1; i<R; i++) f[i] = 0.0;
