...
struct unrollVecSum<from,from,step>{
  static inline void fast_VecSum(float *x, float s){ x[0] = s; }
  static inline void fast_VecSum(const float *x, float s, float *r){ r[0] = s; }
  static inline void VecSum(float *x, float s){ x[0] = s; }
  static inline void VecSum(const float *x, float s, float *r){ r[0] = s; }
};

template<int sX>
static inline void fast_VecSum(float *x){
...
template<int sX>
static inline void fast_VecSum(const float *x, float *r){
...
template<int sX>
static inline void VecSum(float *x){
  float s = fast_two_sum(x[sX-2], x[sX-1], x[sX-1]);
  #ifdef UNROLL_RENORM
...
template<int sX>
static inline void VecSum(const float *x, float *r){
  float s = fast_two_sum(x[sX-2], x[sX-1], r[sX-1]);
	#ifdef UNROLL_RENORM
...
template<int sX>
static inline void VecSum_4Add1(const float *x, const float y, float *r){
...
static inline void fast_VecSumErrBranch(float *x){
	int ptr = 0, i = 1;
	float e = x[0];
...
template<int sX, int sR>
static inline void fast_VecSumErrBranch(const float *x, float *r){
  int ptr = 0, i = 1;
  float e = x[0];
...
/***************************************************************/
template<int sX>
static inline void fast_VecSumErr(float *x){
	float e;
...
template<int sX>
static inline void fast_VecSumErr(const float *x, float *r){
  float e;
...
// Renormalize
template<int sX, int sR>
static inline void fast_renorm2L(float *x){
	float e;
	int ptr = 0, i = 2;
...
template<int sX, int sR>
static inline void fast_renorm2L(const float *x, float *r){
  float e, f[sX];
  int ptr = 0, i = 2;
...
template<int sX, int sR>
static inline void renorm2L(float *x){
  float e;
  int ptr = 0, i = 2;
...
template<int sX, int sR>
static inline void renorm2L(const float *x, float *r){
  float e, f[sX];
  int ptr = 0, i = 2;
...
template<int sX, int sR>
static inline void renorm2L_4Add1(const float *x, const float y, float *r){
  float e, f[sX+1];
  int ptr = 0, i = 2;
...
/** Algorithm for normalizing the array x. The result satisfies |x_i|<ulp(x_{i-1}); P-nonoverlapping expansion.
    ...
    Requirement: sR <= sX **/
template<int sX, int sR>
static inline void fast_renorm3L(float *x){
  float e;
	int ptr = 0, i = 2;
...
template<int sX, int sR>
static inline void fast_renorm3L(float *x, float *r){
  float e, f[sX];
  int ptr = 0, i = 2;
...
// Renormalize_random
template<int sX, int sR>
static inline void renorm_rand2L(float *x){
	float pr;
	int i, j, ptr = 0;
...
template<int sX, int sR>
static inline void renorm_rand2L(const float *x, float *r){
  float pr, f[sX];
  int i, j, ptr = 0;
