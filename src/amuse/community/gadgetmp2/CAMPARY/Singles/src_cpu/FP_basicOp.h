...
/*****************************************************************************************/
static inline float FPadd_rn(const float x, const float y){
  return x + y;
}
...
/**********************************************************************************************/
static inline float FPmul_rn(const float x, const float y){
  return x * y;
}
...
/**********************************************************************************************/
static inline float FPdiv_rn(const float x, const float y){
  return x / y;
}
...
static inline float fma_d_rn_cpu(const float x, const float y, float xy) {
...
static inline float FPfma_rn(const float x, const float y, const float z){
	#ifdef FP_FAST_FMA
  //#warning cpu has fma
	  return fma(x, y, z);
	#else
