...
contains
  ...
  subroutine mainloop()
    ...
    snaps: do snapn = GV%StartSnapNum, GV%EndSnapNum
       ...
       ! if there are no sources, we just evolve the gas
       ! with photoionisation rates = 0
       !----------------------------------------------------------------
       ...
       ! this brings all the particles up to date
       ! by performing a non photo-update 
       !----------------------------------------------------
