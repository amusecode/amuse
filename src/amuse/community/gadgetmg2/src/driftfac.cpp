 ...
 */
void gadgetmg2::init_drift_table(void)
{
 ...
 *  \frac{{\rm d}a}{H(a)} * \f]
 */
double gadgetmg2::get_drift_factor(int time0, int time1)
{
 ...
 */
double gadgetmg2::get_gravkick_factor(int time0, int time1)
{
  double a1, a2, df1, df2, u1, u2;
  int i1, i2;
 ...
 */
double gadgetmg2::get_hydrokick_factor(int time0, int time1)
{
  double a1, a2, df1, df2, u1, u2;
  int i1, i2;
 ...
 */
double gadgetmg2::drift_integ(double a, void *param)
{
  double h;
 ...
 */
double gadgetmg2::gravkick_integ(double a, void *param)
{
  double h;
 ...
 */
double gadgetmg2::hydrokick_integ(double a, void *param)
{
  double h;
...
double gadgetmg2::growthfactor_integ(double a, void *param)
{
  double s;
