 ...
 *  particles .
 */
void gadgetmg2::hydro_force(void)
{
 ...
 */
void gadgetmg2::hydro_evaluate(int target, int mode)
{
  int j, k, n, timestep, startnode, numngb;
  double *pos, *vel;
  double mass, h_i, dhsmlDensityFactor, rho, pressure, f1, f2;
#ifdef MORRIS97VISC
  double alpha_visc, alpha_visc_j;
#endif
 ...
 */
int gadgetmg2::hydro_compare_key(const void *a, const void *b)
{
