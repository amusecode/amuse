 ...
 */
void gadgetmg2::peano_hilbert_order(void)
{
  int i;
 ...
 */
int gadgetmg2::compare_key(const void *a, const void *b)
{
 ...
 *  once.)
 */
void gadgetmg2::reorder_gas(void)
{
  int i;
 ...
 *  once.)
 */
void gadgetmg2::reorder_particles(void)
{
  int i;
  struct particle_data Psave, Psource;
  int idsource, idsave, dest;
 ...
 */
peanokey gadgetmg2::peano_hilbert_key(int x, int y, int z, int bits)
{
...
void gadgetmg2::peano_hilbert_key_inverse(peanokey key, int bits, int *x, int *y, int *z)
{
