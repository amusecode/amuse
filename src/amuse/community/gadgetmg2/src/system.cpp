 ...
 *  integer values.
 */
double gadgetmg2::get_random_number(int id)
{
 ...
 */
void gadgetmg2::set_random_numbers(void)
{
  int i;
 ...
 */
double gadgetmg2::timediff(double t0, double t1)
{
  double dt;
 ...
 */
double gadgetmg2::dmax(double x, double y)
{
  if(x > y)
    return x;
  else
 ...
 */
double gadgetmg2::dmin(double x, double y)
{
  if(x < y)
    return x;
  else
 ...
 */
int gadgetmg2::imax(int x, int y)
{
  if(x > y)
    return x;
  else
 ...
 */
int gadgetmg2::imin(int x, int y)
{
  if(x < y)
    return x;
  else
