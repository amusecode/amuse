 ...
 *  as a tuning measure.
 */
void gadgetmg2::domain_Decomposition(void)
{
  double t0, t1;
 ...
 *  PartAllocFactor.
 */
void gadgetmg2::domain_decompose(void)
{
  int i, j, status;
 ...
 *  it was assigned to.
 */
int gadgetmg2::domain_findSplit(int cpustart, int ncpu, int first, int last)
{
 ...
 */
void gadgetmg2::domain_shiftSplit(void)
{
 ...
 */
void gadgetmg2::domain_findExchangeNumbers(int task, int partner, int sphflag, int *send, int *recv)
{
 ...
 */
void gadgetmg2::domain_exchangeParticles(int partner, int sphflag, int send_count, int recv_count)
{
 ...
 *  decomposition.
 */
void gadgetmg2::domain_countToGo(void)
{
  int n, no;
 ...
 *  processors.
 */
void gadgetmg2::domain_walktoptree(int no)
{
  int i;
 ...
 */
void gadgetmg2::domain_sumCost(void)
{
  int i, n, no;
  ...
  local_DomainWork = new double[NTopnodes];
 ...
 */
void gadgetmg2::domain_findExtent(void)
{
  int i, j;
 ...
 *  number of particles.
 */
void gadgetmg2::domain_determineTopTree(void)
{
 ...
 */
void gadgetmg2::domain_topsplit_local(int node, peanokey startkey)
{
  int i, p, sub, bin;
 ...
 *  (TOPNODEFACTOR * NTask).
 */
void gadgetmg2::domain_topsplit(int node, peanokey startkey)
{
  int i, p, sub, bin;
 ...
 */
int gadgetmg2::domain_compare_toplist(const void *a, const void *b)
{
...
/*! This is a comparison kernel used in a sort routine.
 */
int gadgetmg2::domain_compare_key(const void *a, const void *b)
{
