...
/*void hydro_state_evaluate(double h, double pos[3], double vel[3], double *numngb,
    double *dhsml_out, double *rho_out, double *rhov_out, double *rhov2_out, double
    *rhoe_out);
*/
void gadgetmg2::hydro_state_at_point(double pos[3], double vel[3], double *h_out, double *ngb_out,
...
void gadgetmg2::hydro_state_evaluate(double h, double pos[3], double vel[3],
    double *numngb_out, double *dhsml_out, double *rho_out, double *rhov_out,
