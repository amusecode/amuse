...
# setting/ getting parameters
    ...
    def get_viscosity_switch():
        ...
        function.addParameter('viscosity_switch', dtype='string', direction=function.OUT,
            description = "The viscosity switch used by Gadgetmg2.")
        function.result_type = 'int32'
        return function
    ...
    def get_time_limit_cpu():
        ...
        function.addParameter('time_limit_cpu', dtype='d', direction=function.OUT,
            description = "The cpu-time limit. Gadgetmg2 will stop once 85% of this (wall-clock) time has passed.")
        function.result_type = 'i'
        return function
    @legacy_function
...
class Gadgetmg2Doc(object):

    def __get__(self, instance, owner):
        return instance.legacy_interface.__doc__+"\n\n"+instance.parameters.__doc__

class Gadgetmg2(GravitationalDynamics, GravityFieldCode):
    
    __doc__ = Gadgetmg2Doc()
    
    def __init__(self, unit_converter = None, mode = 'normal', **options):
        self.mode = mode
        legacy_interface = Gadgetmg2Interface(mode = mode, **options)
    ...
    def define_parameters(self, handler):
        ...
        handler.add_method_parameter(
            ...
            None,
            "timestep", 
            "timestep for system, Gadgetmg2 calculates this by itself, based on particle acceleration.", 
        ...
        handler.add_method_parameter(
            ...
            None,
            "viscosity_switch", 
            "Viscosity switch used by Gadgetmg2", 
            default_value = "standard Gadgetmg2 viscosity"
        )
        ...
        handler.add_method_parameter(
            ...
            "set_time_limit_cpu",
            "time_limit_cpu", 
            "The cpu-time limit. Gadgetmg2 will stop once 85% of this (wall-clock) time has passed.", 
        ...
        handler.add_boolean_parameter(
            ...
            "Flag telling Gadgetmg2 whether to interpret external changes to particles' velocities as feedback (for timestepping).",
            False
        )
        ...
        handler.add_boolean_parameter(
            ...
            "Flag telling Gadgetmg2 whether to interpret external changes to particles' internal energy as feedback (for timestepping).",
            True
        )
