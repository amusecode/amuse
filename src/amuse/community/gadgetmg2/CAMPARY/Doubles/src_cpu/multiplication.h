...
struct unrollPartialProds{
	static void inline unrollX_trunc(const int exp_start, const int LBN, const double *x, const int *exp_x, const double *y, const int *exp_y, double *B){
	...
	static void inline unrollX_all(const int exp_start, const int LBN, const double *x, const int *exp_x, const double *y, const int *exp_y, double *B){
	...
	static void inline unrollY(const int exp_start, const int LBN, const double x, const int exp_x, const double *y, const int *exp_y, double *B){
		double p, e;
	...
	static void inline unroll_simple1(const int exp_start, const int LBN, const double *x, const int *exp_x, const double *y, const int *exp_y, double *B){
		double p;
	...
	static void inline unroll_simple2(const int exp_start, const int LBN, const double *x, const int *exp_x, const double *y, const int *exp_y, double *B){
		double p;
...
static inline void certifiedMul(const double *x, const double *y, double *r){
...
template <int K, int L, int R>
static inline void truncatedMul(const double *x, const double *y, double *r){
	int const LBN = R*dbl_prec/binSize + 2;
  double B[LBN+2], lim[LBN+2];
  int i;
...
template <int K, int L, int R>
static inline void baileyMul_fast(double const *x, double const *y, double *z){
  double p, e, f[R+1];
  int i, j, n = R;
...
template <int K, int L, int R>
static inline void baileyMul_renorm(double const *x, double const *y, double *z){
  double p, e, f[R+1];
  int i, j, n = R;
  for(i=K+L-1; i<R; i++) f[i] = 0.0;
