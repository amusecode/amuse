...
/****************************************************/
template<> void inline invNewtonUp<1,1>(const float *x, float *res){ res[0] = FPdiv_rn( 1., x[0] ); }

/****************************************************/
template<> void inline divNewton<1,1,1>(const float *x, const float *y, float *res){ res[0] = FPdiv_rn( x[0], y[0] ); }
template<> void inline divNewton<2,1,2>(const float *x, const float *y, float *res){
...
template<> void inline divNewton<2,2,2>(const float *x, const float *y, float *res){
...
/****************************************************/
template<> void inline invNewtonUp_fast<1,1>(const float *x, float *res){ res[0] = 1./x[0]; }

/****************************************************/
template<> void inline divNewton_fast<1,1,1>(const float *x, const float *y, float *res){ res[0] = x[0] / y[0]; }
template<> void inline divNewton_fast<2,1,2>(const float *x, const float *y, float *res){
// DWDivFP2 with relative error <= 3.5u^2
  float t, rh, rl;
  t = FPdiv_rn( x[0], y[0] );
  rh = two_prod( t, y[0], rl );
...
template<> void inline divNewton_fast<2,2,2>(const float *x, const float *y, float *res){
// DWDivDW2 with relative error <= 15u^2 + 56u^3
  float t, r[2];
  t = FPdiv_rn( x[0], y[0] );
  certifiedMul<2,1,2>( y, &t, r );
...
/****************************************************/
template<> void inline sqrtInvNewton<1,1>(float const *x, float *res){ res[0] = 1/sqrt(x[0]); }

/****************************************************/
template<> void inline sqrtNewton<1,1>(float const *x, float *res){ res[0] = sqrt(x[0]); }

/****************************************************/
template<> void inline sqrtHeron<1,1>(float const *x, float *res){ res[0] = sqrt(x[0]); }

/****************************************************/
template<> void inline sqrtInvNewton_fast<1,1>(float const *x, float *res){ res[0] = 1/sqrt(x[0]); }

/****************************************************/
template<> void inline sqrtNewton_fast<1,1>(float const *x, float *res){ res[0] = sqrt(x[0]); }

/****************************************************/
template<> void inline sqrtHeron_fast<1,1>(float const *x, float *res){ res[0] = sqrt(x[0]); }
