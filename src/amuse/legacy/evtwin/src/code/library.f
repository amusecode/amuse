...
!  physics options (default: ./init.dat)
      ...
      implicit none
      character*500, intent(in) :: new_init_dat_name;
...
!  physics options (default: ./init.dat)
      ...
      use file_exists_module
      implicit none
      character*500, intent(in) :: new_init_run_name;
...
!  Returns the star's luminosity, in solar units
      ...
      use constants
      implicit none
      double precision :: get_luminosity
      integer, intent(in) :: id
...
!  Returns the star's effective temperature, in Kelvin
      ...
      use constants
      implicit none
      double precision :: get_temperature
      integer, intent(in) :: id
