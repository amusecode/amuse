...
from amuse.legacy.ph4.interface import ph4
...
def test_ph4(number_of_stars = 50,
    ...
    gravity.parameters.timestep_parameter = 0.1
    gravity.parameters.epsilon_squared = \
       (float(number_of_stars))**(-0.666667) | nbody_system.length**2
...
if __name__ == '__main__':
    ...
    try:
        opts, args = getopt.getopt(sys.argv[1:], "d:gn:t:w:")
