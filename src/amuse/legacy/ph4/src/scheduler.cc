...
{
    char *in_function = "scheduler::initialize";
...
real scheduler::get_list(int *ilist, int& n) const
{
    char *in_function = "scheduler::get_list";
    if (DEBUG > 2 && jd->mpi_rank == 0) PRL(in_function);
...
{
    char *in_function = "scheduler::find_block";
...
void scheduler::update()
{
    char *in_function = "scheduler::update";
    if (DEBUG > 2 && jd->mpi_rank == 0) PRL(in_function);
...
void scheduler::add_particle(int j)
{
    char *in_function = "scheduler::add_particle";
    if (DEBUG > 2 && jd->mpi_rank == 0) PRL(in_function);
...
void scheduler::remove_particle(int j)
{
    char *in_function = "scheduler::remove_particle";
    if (DEBUG > 2 && jd->mpi_rank == 0) PRL(in_function);
...
void scheduler::print_blist()
{
    char *in_function = "scheduler::print_blist";
    if (DEBUG > 2 && jd->mpi_rank == 0) PRL(in_function);
...
{
    char *in_function = "scheduler::print_bp";
    if (DEBUG > 2 && jd->mpi_rank == 0) PRL(in_function);
...
{
    char *in_function = "scheduler::print";
    if (DEBUG > 2 && jd->mpi_rank == 0) PRL(in_function);
...
{
    char *in_function = "scheduler::check";
    if (DEBUG > 2 && jd->mpi_rank == 0) PRL(in_function);
