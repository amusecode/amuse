...
class vec
{
	...
	/// Scalar divide.
        ...
        // Bool ==, !=: apparently can't do bit-by-bit compare because
        // the member data are private.  Hence these need to be friends
	// in order to apply these operators.  Almost never used,
	// however...
	...
	// this is an interesting way to resolve the ambiguity of
	// resolving  v*s vs. s*v and the confusion of having a v*v
	// with a non-explicit vec constructor from a scalar...
