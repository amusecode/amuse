...
__all__ = [
        "MultiplePartIMF", "new_broken_power_law_mass_distribution",
        "new_scalo_mass_distribution", "new_miller_scalo_mass_distribution",
...
class MultiplePartIMF(object):
    def __init__(
            self, mass_boundaries=[0.1, 125.0] | units.MSun,
            mass_max=None, alphas=[-2.35], random=True):
...
def new_broken_power_law_mass_distribution(
    ...
    :argument mass_boundaries: the boundaries of the mass ranges (default:
    [0.1, 125.0] MSun)
...
def new_scalo_mass_distribution(
    ...
    return MultiplePartIMF(
        mass_boundaries=[
            0.10, 0.18, 0.42, 0.62, 1.18, 3.5, 125.0,
            ] | units.MSun,
        mass_max=mass_max,
...
def new_miller_scalo_mass_distribution(
        number_of_particles, mass_max=None, random=True):
    """Returns a Miller & Scalo (1979) mass distribution in SI units, with mass
    ranges:
