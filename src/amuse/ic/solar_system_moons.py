...
def get_position(
        mass_sun, mass_planet, ecc, semi, mean_anomaly, incl, argument,
        longitude, delta_t=0. | units.day):
    """
...
def new_lunar_system_in_time(time_JD=2457099.5 | units.day):
    ...
    # ## to compare with JPL, relative positions and velocities need to be
    # corrected for the
    #  Sun's vectors with respect to the barycenter
    # r_s = (3.123390770608490E-03, -4.370830943817017E-04,
    # -1.443425433116342E-04) | units.AU
    # v_s = (3.421633816761503E-06,  5.767414405893875E-06,
    # -8.878039607570240E-08) | (units.AU / units.day)
    # print sun
...
def new_option_parser():
    ...
    result = OptionParser()
    result.add_option(
            "-d", dest="Julian_date", unit=units.day, type=float,
            default=2438871.5 | units.day, help="julian date [%default]")
    return result
