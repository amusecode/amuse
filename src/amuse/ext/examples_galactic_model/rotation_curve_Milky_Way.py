#---------------------------------------------------------------------------
# This script generates the rotation curve of the Milky Way                 |
# using galactic_model.                                                     |
...
def  plot_rotation_curves(r, vc, vc1):
    ...
    ax.plot(x.value_in(units.kpc), vc.value_in(units.kms), label= 'Model with bar and spiral arms')
    ax.plot(x.value_in(units.kpc), vc1.value_in(units.kms), label= 'Only axisymmetric')
...
if __name__ in('__main__', '__plot__'):
    ...
    x,y,z= numpy.linspace(0.01,15,500) |units.kpc, 0|units.kpc, 0|units.kpc
    ...
    plot_rotation_curves(x, circular_velocity, circular_velocity_axisymmetric_component)
