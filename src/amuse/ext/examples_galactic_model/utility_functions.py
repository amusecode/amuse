#---------------------------------------------------------------------------
# Script that shows the utility functions of galactic_model.                |
...
def tidal_tensor(t,x,y,z, galaxy):
     Fxx, Fyx, Fzx, Fxy,Fyy,Fzy, Fxz, Fyz, Fzz= galaxy.get_tidal_tensor(t, x,y,z)
     return VectorQuantity.new_from_scalar_quantities(Fxx, Fyx, Fzx,
                                                      Fxy, Fyy, Fzy,
                                                      Fxz, Fyz, Fzz)
...
if __name__ in('__main__', '__plot__'):
    ...
    time, x, y, z= 0 |units.Myr, 8.5 | units.kpc, 0 |units.kpc, 0 |units.kpc
    ...
    print 'tidal tensor:', Tij.value_in(100*units.kms**2/units.kpc**2),'\n','eigen values:', eigenValues.value_in(100*units.kms**2/units.kpc**2), '\n','tidal radius:', tidal_radius.value_in(units.parsec), '\n','local stellar density:', local_stellar_density.value_in(units.MSun/units.parsec**3)
