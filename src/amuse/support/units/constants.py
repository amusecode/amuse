...
#NIST_URL = "http://physics.nist.gov/cuu/Constants/Table/allascii.txt"
...
#or change them, change the nist.txt file an run constants.py
...
class Constants(object):
    ...
    def generate_nist(self):
        ...
        f = open(self.I.directory+'/nist.py','w')
