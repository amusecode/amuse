...
variables = [
        ...
        ["fuvheat", 'd', 14, "gas", units.none],  # special case: -> units of
                                                  # Habing field
        ...
        ["pressure", 'd', 20, "gas",
            nbody_system.mass / nbody_system.length / nbody_system.time**2],
        ...
        ["snentropy", 'd', 35, "stars", units.none],  # not sure about this
                                                      # unit
...
class FiFileFormatProcessor(base.FortranFileFormatProcessor):
    ...
    def load_header(self, file):
        ...
        self.convert = nbody_system.nbody_to_si(
                self.unitm_in_msun | units.MSun,
                self.unitl_in_kpc | units.kpc,
                )
        ...
        self.heatconst = (
                2.0693e14
                * self.unitl_in_kpc**2.5
                / self.unitm_in_msun**1.5
                )
...
def parse_old_runinfo_file(path):
    """parses the old runinfo file and returns its contents as a dict"""
