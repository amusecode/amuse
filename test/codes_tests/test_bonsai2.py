...
#            expected_message = "Error when calling 'delete_particle' of a 'Bonsai', errorcode is -2")
    ...
    def test7(self):
        ...
        self.assertAlmostEquals(instance.potential_energy, -0.50625962019 | nbody_system.energy)
        self.assertAlmostEquals(instance.kinetic_energy,    0.244611829519 | nbody_system.energy)
        ...
        instance.evolve_model(1.0 | nbody_system.time)
        self.assertAlmostEquals(instance.model_time, 1.0 | nbody_system.time)
        self.assertAlmostEquals(instance.potential_energy, -0.5115 | nbody_system.energy, 4)
        self.assertAlmostEquals(instance.kinetic_energy,    0.24986 | nbody_system.energy, 4)
