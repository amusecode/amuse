...
class TestPikachuInterface(TestWithMPI):
    ...
    def test4(self):
        ...
        self.assertEqual([1.0e-8, 0], instance.get_eps2_fs_fs().values())
        self.assertEqual([1.0e-8, 0], instance.get_eps2_fs_bh().values())
        ...
        self.assertEqual([0.005, 0], instance.get_eta_s().values())
        self.assertEqual([0.025, 0], instance.get_eta_fs().values())
        self.assertEqual([0.025, 0], instance.get_eta_smbh().values())
