...
class GalactICsInterfaceTests(TestWithMPI):
    ...
    def test2(self):
        ...
        self.assertEqual([False, 0], instance.get_generate_halo_flag().values())
        self.assertEqual([False, 0], instance.get_disk_do_center_flag().values())
        self.assertEqual([50000, 0], instance.get_number_of_grid_intervals().values())
        self.assertEqual([-1234, 0], instance.get_disk_random_seed().values())
        self.assertEqual([250.0, 0], instance.get_halo_outer_radius().values())
        self.assertEqual([0.4, 0], instance.get_bulge_streaming_fraction().values())
    ...
    def test4(self):
        ...
        self.assertEqual(instance.get_number_of_particles_updated().values(), [0, 0])
        self.assertEqual(instance.generate_particles(), 0)
        self.assertEqual(instance.get_number_of_particles_updated().values(), [number_of_particles_halo, 0])
