...
class TestParameterDoc(amusetest.TestCase):
    ...
    def test_bhtree(self):
        ...
        self.assertTrue("smoothing parameter for gravity calculations (default value:0.3 nbody length * nbody length)" in docstring)
        print docstring
    ...
    def test_phigrape(self):
        ...
        self.assertTrue("smoothing parameter for gravity calculations (default value:0.0 nbody length * nbody length)" in docstring)
        ...
        self.assertTrue("epsilon_squared: 10000000.0 m**2" in parameter_str_method_output)
        self.assertTrue("timestep_parameter: 4.47422288341e-16" in parameter_str_method_output)
