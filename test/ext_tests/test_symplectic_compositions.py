...
class TestSymplecticCompositions(amusetest.TestCase):
  def test1(self):
    from amuse.ext.symplectic_composition import LEAPFROG
    dt1=.1
  ...
  def test2(self):
    from amuse.ext.symplectic_composition import SPLIT_4TH_S_M6
    dt1=.5
  ...
  def test3(self):
    from amuse.ext.symplectic_composition import SPLIT_4TH_S_M5
    dt1=.5
    ...
    self.assertEqual(order, 4)        
  def test4(self):
    from amuse.ext.symplectic_composition import SPLIT_4TH_S_M4
    dt1=.5
    ...
    self.assertEqual(order, 4)
  def test5(self):
    from amuse.ext.symplectic_composition import SPLIT_6TH_SS_M11
    dt1=.5
  ...
  def test6(self):
    from amuse.ext.symplectic_composition import SPLIT_6TH_SS_M13
    dt1=.5
    ...
    self.assertEqual(order, 6)                
  def test7(self):
    from amuse.ext.symplectic_composition import SPLIT_8TH_SS_M21
    dt1=1.
  ...
  def test8(self):
    from amuse.ext.symplectic_composition import SPLIT_10TH_SS_M35
    dt1=1.
