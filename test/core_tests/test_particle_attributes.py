...
class TestParticlesAttributes(amusetest.TestCase):
    ...
    def test1(self):
        ...
        self.assertEquals(particles.kinetic_energy(), 0.5 | nbody_system.energy)
        self.assertEquals(particles.potential_energy(G=nbody_system.G), -0.125 | nbody_system.energy)
