...
class TestHermiteInterface(TestWithMPI):
    ...
    def test0(self):
        instance = HermiteInterface(channel_type='ibis')
    ...
    def test3(self):
        hermite = HermiteInterface(channel_type='ibis')
        hermite.eps2 = 0.101
...
class TestHermite(TestWithMPI):
    ...
    def test1(self):
        ...
        hermite = Hermite(convert_nbody, channel_type='ibis')
        hermite.initialize_code()
    ...
    def test2(self):
        ...
        instance = Hermite(convert_nbody, channel_type='ibis')
        instance.initialize_code()
    ...
    def test3(self):
        ...
        instance = Hermite(convert_nbody, redirection="none", channel_type='ibis')
        instance.initialize_code()
    ...
    def test8(self):
        ...
        instance = Hermite(channel_type='ibis')
        instance.initialize_code()
        instance.particles.add_particles(particles) 
    ...
    def test13(self):
        ...
        instance = Hermite(number_of_workers=1, channel_type='ibis')#, debugger="xterm")
        instance.initialize_code()
        ...
        for n in [2,3,4,5]:
            instance = Hermite(number_of_workers=n, channel_type='ibis')
            instance.initialize_code()
            instance.parameters.epsilon_squared = 0.01 | nbody_system.length ** 2
            instance.particles.add_particles(particles)
